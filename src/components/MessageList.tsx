    ...
    <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4">
      {messages.length === 0 && (
        <div className="text-center text-gray-500 mt-6 sm:mt-8 px-4">
          <h2 className="text-lg sm:text-xl font-semibold mb-2">Welcome to RPG Story Generator</h2>
          <p className="text-sm">Start by uploading context documents or describe your RPG campaign idea.</p>
          <div className="mt-4 text-left max-w-md mx-auto bg-gray-50 p-3 sm:p-4 rounded-lg">
            <p className="font-medium mb-2 text-sm sm:text-base">Suggested workflow:</p>
